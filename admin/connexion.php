    ...
    if(empty($_POST['pseudo'])) {
        ...
        if(empty($_POST['mdp'])) {
            ...
            if(!$mysqli){
                ...
                $Requete = mysqli_query($mysqli,"SELECT 'identifiant','mdp' FROM utilisateurs WHERE identifiant = '".$Pseudo."' AND mdp = '".$MotDePasse."'");//si vous avez enregistré le mot de passe en md5() il vous suffira de faire la vérification en mettant mdp = '".md5($MotDePasse)."' au lieu de mdp = '".$MotDePasse."'
